...
def aggregation_results_final_algorith(results):
    ##### Agregation of results
    cols_numeric = results.select_dtypes([np.number]).columns
    df_aggre_mean = results.groupby(['n_ensemble', 'weights'], as_index=False)[cols_numeric].mean()
    df_aggre_mean.columns = ['n_ensemble', 'weights', 'accuracy_mean',
    ...
    for n_i in n_ensemble_list:
        ...
        for w in weights_list:
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_Hostility_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_Hostility_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_kDN_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_kDN_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_DCP_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_DCP_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_TD_U_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_TD_U_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_CLD_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_CLD_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_N1_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_N1_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_N2_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_N2_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_LSC_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_LSC_class_std'] = 'Lost_class'
            ...
            try:
                ...
                df_aggre.loc[condition2, 'Boots_F1_class_mean'] = 'Lost_class'
                df_aggre.loc[condition2, 'Boots_F1_class_std'] = 'Lost_class'
...
def aggregation_results_final_algorithm_cycle(results):
    ##### Agregation of results
    cols_numeric = results.select_dtypes([np.number]).columns
    df_aggre_mean = results.groupby(['n_cycle','n_ensemble', 'weights'], as_index=False)[cols_numeric].mean()
    df_aggre_mean.columns = ['n_cycle','n_ensemble', 'weights', 'accuracy_mean',
                             'Boots_Hostility_dataset_mean', 'Boots_kDN_dataset_mean', 'Boots_DCP_dataset_mean',
                             'Boots_TD_U_dataset_mean', 'Boots_CLD_dataset_mean', 'Boots_N1_dataset_mean',
                             'Boots_N2_dataset_mean', 'Boots_LSC_dataset_mean', 'Boots_F1_dataset_mean']
    df_aggre_std = results.groupby(['n_cycle','n_ensemble', 'weights'], as_index=False)[cols_numeric].std()
    df_aggre_std.columns = ['n_cycle','n_ensemble', 'weights', 'accuracy_std', 'Boots_Hostility_dataset_std',
                            'Boots_kDN_dataset_std', 'Boots_DCP_dataset_std',
                            'Boots_TD_U_dataset_std', 'Boots_CLD_dataset_std', 'Boots_N1_dataset_std',
                            'Boots_N2_dataset_std', 'Boots_LSC_dataset_std', 'Boots_F1_dataset_std']

    df_aggre = pd.concat([df_aggre_mean, df_aggre_std.iloc[:, 3:]], axis=1)
