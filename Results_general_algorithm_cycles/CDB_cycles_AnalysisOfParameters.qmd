...
Once the number of cycles is reduced, we perform a similar analysis on the alpha parameter and on the split parameter.
...
-   From 14 to 30, almost all comparisons are not significantly different --\> maximum value of split should be 16
