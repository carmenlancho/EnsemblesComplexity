...
datos_alpha_s_1$n_cycle <- as.numeric(datos_alpha_s_1$n_cycle)
datos_alpha_s_1$n_ensemble <- as.numeric(datos_alpha_s_1$n_ensemble)
plot(datos_alpha_s_1$n_cycle,datos_alpha_s_1$accuracy_mean_dataset_mean)
```

```{r}
datos_alpha_s_2 <- datos_alpha_s %>% filter(alpha==2, split==2)
datos_alpha_s_2 <- as.data.frame(datos_alpha_s_2)
datos_alpha_s_2$n_cycle <- as.numeric(datos_alpha_s_2$n_cycle)
datos_alpha_s_2$n_ensemble <- as.numeric(datos_alpha_s_2$n_ensemble)
plot(datos_alpha_s_1$n_ensemble,datos_alpha_s_1$accuracy_mean_dataset_mean, type='l')
points(datos_alpha_s_2$n_ensemble,datos_alpha_s_2$accuracy_mean_dataset_mean, type='l', col='red')
```
